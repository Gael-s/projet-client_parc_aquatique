...
CREATE TABLE `parc_aquatique`.`tarif` (
  ...
  INSERT INTO `parc_aquatique`.`tarif` (`adulte`, `enfant`, `enfant_3_ans`, `sauna_et_hammam`, `abonnement_sauna`, `cours`, `adultEte`, `enfantEte`) VALUES ('4','3.20','0','10','75','5','4.70','3.70');